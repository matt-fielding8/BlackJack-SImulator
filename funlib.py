...
def card_decks():
    ...
    Creates n number of card decks arrays consisting of 4 sets, with card id at index 0 and card value at index [1:].
    ...
    playing_deck = []
    n = input("How many decks of cards would you like? ")
